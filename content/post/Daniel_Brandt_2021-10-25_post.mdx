...
is, as a noun: [שָּׂטָן]{dir="rtl"}, or could be transliterated as
...
hebrew*, the word [שָּׂטָן]{dir="rtl"} is found 27 times, in **23** verses
...
[שָּׂטָן]{dir="rtl"}. Also, Job is a situation where we see the use of
